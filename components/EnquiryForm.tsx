...
export default function EnquiryForm({
  ...
  return (
    <div
      id="enquire"
      className="rounded-3xl bg-charcoal text-cream p-8 md:p-12 grid lg:grid-cols-2 gap-10 lg:gap-16"
    >
      <div>
        ...
        <div className="mt-8 space-y-3">
          <a href="tel:+97145608200" className="flex items-center gap-3 text-sm text-cream/80 hover:text-cream">
            <Phone size={16} className="text-sage-300" />
            +971 4 560 8200
          </a>
          <a href="https://wa.me/971504301555" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm text-cream/80 hover:text-cream">
            <MessageCircle size={16} className="text-sage-300" />
            +971 50 430 1555
          </a>
          <a href="mailto:connect@flowork.ae" className="flex items-center gap-3 text-sm text-cream/80 hover:text-cream">
      ...
      <div>
        {status === "success" ? (
          <motion.div
            ...
            className="rounded-2xl border border-sage-500/30 bg-sage-500/10 p-8 text-center h-full flex flex-col items-center justify-center"
          >
