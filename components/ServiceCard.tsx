  ...
  return (
    ...
    >
      <Link href={href} className="group block">
        <div className="relative aspect-[4/5] rounded-2xl overflow-hidden bg-sage-100">
          <Image
            src={image}
            alt={title}
            fill
          ...
          />
          <div className="absolute bottom-4 right-4 h-10 w-10 rounded-full bg-cream flex items-center justify-center transition-transform duration-300 group-hover:rotate-45">
